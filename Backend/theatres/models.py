...
class Theatre(models.Model):
    owner = models.ForeignKey(
        "theatre_owner.TheaterOwnerProfile",
    ...
    city = models.ForeignKey(
        "movies.City", on_delete=models.CASCADE, related_name="theatres"
    )
...
class TimeSlot(models.Model):
    screen = models.ForeignKey(
        Screen, on_delete=models.CASCADE, related_name="time_slot"
    )
...
class ShowTime(models.Model):
    ...
    movie = models.ForeignKey(
        "movies.Movie", on_delete=models.CASCADE, related_name="TimeSlotSlot"
    )
