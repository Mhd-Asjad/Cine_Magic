...
class Booking(models.Model):
    ...
    refunt_status = models.CharField(
        max_length=20, choices=REFUND_STATUS_CHOICES, default="not-applicable"
    )
...
class BookingSeat(models.Model):
    ...
    booking = models.ForeignKey(
        Booking, on_delete=models.CASCADE, related_name="bookingseats"
    )
    seat = models.ForeignKey("seats.seats", on_delete=models.CASCADE)
    status = models.CharField(
        max_length=20, choices=SEAT_STATUS_CHOISES, default="booked"
    )
...
class Notifications(models.Model):
    ...
    user = models.ForeignKey(
        "useracc.User", on_delete=models.CASCADE, related_name="notifications"
    )
    ...
    complaint = models.ForeignKey(
        "review.Complaints", on_delete=models.CASCADE, null=True, blank=True
    )
